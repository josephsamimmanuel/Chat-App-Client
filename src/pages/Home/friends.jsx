        ...
        <div className='w-full'>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4'>
                ...
                <div className='flex flex-col gap-2 border border-gray-300 rounded-md p-4 w-full shadow-sm hover:shadow-md transition-shadow duration-200'>
                    ...
                    <button className='w-full btn btn-primary border border-gray-300 rounded-3xl mt-2 text-sm sm:text-base py-1.5 hover:bg-blue-700 transition-colors duration-200'>
                        Message
                    </button>
                </div>
                ))}
